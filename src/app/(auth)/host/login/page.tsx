    ...
    <div className="min-h-screen bg-gradient-to-br from-stone-950 via-amber-950/40 to-stone-950 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-amber-400/70 text-sm mt-1">{siteConfig.hostPortalName}</p>
        </div>
          ...
          <form action={loginAction} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="h-10 w-full rounded-lg border border-stone-300 bg-white px-3 text-sm outline-none focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20"
              />
            </div>
            <div>
            ...
            <button
              type="submit"
              className="w-full h-11 rounded-lg bg-gradient-to-r from-amber-600 to-amber-500 text-white text-sm font-medium hover:from-amber-700 hover:to-amber-600 transition-all"
            >
              Sign In as Host
            </button>
          </form>
